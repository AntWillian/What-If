...
class Fase4:
    ...
    def __init__(self):
        ...
        self.terrain_spritesheet_inferno = Spritesheet("assets/tilemaps_bioma_INFERNO.png")
        ...
        self.bloco_solido2 = pygame.sprite.LayeredUpdates()
    ...
    def createTilemap(self):
        for i, row in enumerate(fase4):
            for j, column in enumerate(row):
                ...
                if column == "R":
                    Block_crack1(self, j, i, "B", self.terrain_spritesheet_inferno)
                if column == "G":
                    Block_plataforma_baixo(self, j, i, "G", self.terrain_spritesheet)
                if column == "$":
                    Block_plataforma_solido(self, j, i, "$", self.terrain_spritesheet)
                if column == "Z":
                    Block_plataforma_baixo(self, j, i, "G", self.terrain_spritesheet_inferno)
                if column == "N":
                ...
                if column == "K":
                    Troncos(self, j, i, "T", self.terrain_spritesheet_inferno)
                if column == "L":  # LADO Direito do tronco
                    Troncos(self, j, i, "L", self.terrain_spritesheet)
                if column == "V":
                    Troncos(self, j, i, "L", self.terrain_spritesheet_inferno)
                if column == "F":
                ...
                if column == "P":
                    self.player = Player_platform(self, j, i, True, False)
